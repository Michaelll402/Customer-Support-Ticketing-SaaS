...
const RootPage = () => {
  return (
    <main className="mx-auto flex min-h-screen max-w-5xl flex-col gap-6 px-6 py-10">
      <PageScaffold
        eyebrow="MILESTONE 4"
        title="Workflow, Notifications, and Realtime"
        description="Auth, ticket core, conversation, internal notes, attachments, staff workflow controls, in-app notifications, and the Socket.IO realtime gateway are all live. SLA, dashboards, and admin CRUD remain deferred to later milestones."
      >
